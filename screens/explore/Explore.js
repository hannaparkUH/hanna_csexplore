        ...
        <Content>
            ...
            <CardItem>
              <Left>
                <Body>
                  ...
                  <Text note>
                    Go out there and make a difference. Use your skills to solve
                    real world problems and get matched with mentors and
                    opportunities.{" "}
                  </Text>
                </Body>
              </Left>
          ...
          <Card>
            <CardItem cardBody>
              <TouchableHighlight
                style={styles.imageBtn}
                onPress={() => navigation.navigate("DegreePlanner")}
              >
                <View style={styles.view}>
                  <Image
                    style={styles.theImage}
